...
import pandas as pd
import os
pictures_path=r'C:\Users\isaac\PycharmProjects\tensorflow_filter\albaugmentations'
...
df.to_csv('dark_glasses_aug.csv',index=False)
#%%
import pandas as pd
df=pd.read_csv('dark_glasses_aug.csv')
#%%