...
import pandas as pd
import os
df=pd.read_csv(r'C:\Users\isaac\PycharmProjects\COFW\augmented.csv')


pictures_path=r'C:\Users\isaac\PycharmProjects\COFW\augmentations'
...
df.to_csv('vgg_aumentations.csv',index=False)
#%%
import pandas as pd
df=pd.read_csv('vgg_aumentations.csv')
#%%