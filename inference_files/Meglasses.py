...
import pandas as pd
import os
pictures_path=r'C:\Users\isaac\Downloads\MeGlass\data\MeGlass_ori'
...
indexes=[x for x in range(len(number_list)) if number_list[x] >1]
...
df.to_csv('meglasses.csv',index=False)
#%%
# import pandas as pd
# df=pd.read_csv('meglasses.csv')
#%%