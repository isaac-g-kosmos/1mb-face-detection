...
data_list =os.listdir(r'C:\Users\isaac\PycharmProjects\google_download\downloads\hats')
data_list=[os.path.join('hats',x) for x in data_list ]
data_list_no_hat=os.listdir(r'C:\Users\isaac\PycharmProjects\google_download\downloads\no_hats')
data_list_no_hat=[os.path.join('no_hats',x) for x in data_list_no_hat]
pictures_path = r'C:\Users\isaac\PycharmProjects\google_download\downloads'
data_list.extend(data_list_no_hat)
...
for x in data_list:
    ...
    # C:\Users\isaac\PycharmProjects\google_download\downloads\no_hat\bald_152.jpeg
    # ax.imshow(img)
    # plt.show()
...
# %%
df.to_csv('scrapped_augmentations.csv')
# C:\Users\isaac\PycharmProjects\face-occlusion-generation\dataset\CelebAMask-HQ\CelebAMask-HQ-mask-anno