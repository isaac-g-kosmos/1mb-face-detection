...
import pandas as pd
import os
df=pd.read_csv(r'C:\Users\isaac\PycharmProjects\tensorflow_filter\hat_df\hat_df.csv')


pictures_path=r'C:\Users\isaac\PycharmProjects\face_exctraction\Ultra-Light-Fast-Generic-Face-Detector-1MB\interview_images'

data_list=os.listdir(r'C:\Users\isaac\PycharmProjects\face_exctraction\Ultra-Light-Fast-Generic-Face-Detector-1MB\interview_images')
...
df.to_csv('vgg_face_hat.csv',index=False)
#%%
import pandas as pd
df=pd.read_csv('vgg_face_hat.csv')
#%%